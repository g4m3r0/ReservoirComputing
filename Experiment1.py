...
base_config = {
    ...
    'N': 500,  # Total number of neurons in the main recurrent layer (reservoir).
    'N_u': 500,  # Total number of neurons in the feedback reservoir.
...
# Impact of number of neurons (N): 50, 100, 250, 500
#experiment_name = "experiment1_N500"
